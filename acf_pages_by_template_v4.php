  ...
  */
  ...
  function create_options( $field )
  {
    ...
    <tr class="field_option field_option_<?php echo $this->name; ?>">
      <td class="label">
        <label for=""><?php _e("Page template",'acf'); ?></label>
        <p class="description">Choose for which template(s) you want to get pages</p>
      </td>
      <td>
        <?php 
      ...
      <tr class="field_option field_option_<?php echo $this->name; ?>">
      <td class="label">
        <label><?php _e("Allow multiple pages?",'acf'); ?></label>
        <p class="description">If yes, user can select multiple pages. Otherwise, only a single one.</p>
      </td>
      <td>
        <?php 
        do_action('acf/create_field', array(
